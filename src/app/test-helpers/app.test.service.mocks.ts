...
export class SeriesServiceStub {
  public MOCK_SERIES = [
    {
      'id': '81189',
  ...
  getTopSeries() {
    return this.fakeAsyncResponse(this.MOCK_SERIES);
  }
...
export class AuthServiceStub {
  ...
  getAuth() {
    return this.fakeAsyncResponse(this.MOCK_GETAUTH);
  }
